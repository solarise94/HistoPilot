 ...
 *
 * {@link PathTogetherHttpClient} is the production {@link PlatformClient}
 ...
 * token (see {@link PathTogetherHttpClientOptions#secret} note). A code scan
...
export interface PathTogetherHttpClientOptions {
 ...
 */
export class PathTogetherHttpClient implements PlatformClient {
	...
	constructor(opts: PathTogetherHttpClientOptions) {
